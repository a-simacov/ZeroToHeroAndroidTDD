...
@Composable
fun MainScreen() {
    val textCount: Count by rememberSaveable { mutableStateOf(Count.Base(step = 2)) }
    var textValue by remember { mutableStateOf(textCount.result()) }
    ...
    Row(
        ...
        Button(
            onClick = {
                textValue = textCount.increment(number = textValue)
            },
